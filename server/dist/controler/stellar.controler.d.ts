...
declare const getAccountTransactions: (req: Request, res: Response, next: import("express").NextFunction) => void;
declare const getTransactionOps: (req: Request, res: Response, next: import("express").NextFunction) => void;
