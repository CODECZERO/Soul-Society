...
export declare function registerMission(captainKey: string, missionId: string, title: string, dangerLevel: number, deadline?: number): Promise<StellarSdk.rpc.Api.SendTransactionResponse>;
