...
fn main() {
    ...
    let mut wasm_path = "target/wasm32-unknown-unknown/release/reiatsu_token.wasm".to_string();
    ...
    // The wasm is at target/wasm32-unknown-unknown/release/reiatsu_token.wasm relative to smartContract
    let deploy_output = Command::new("stellar")
        .args([
            "contract", "deploy",
            "--wasm", "target/wasm32-unknown-unknown/release/reiatsu_token.wasm",
